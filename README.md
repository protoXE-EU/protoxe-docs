...
- Defensive publications (prior art, CC0, hosted on Zenodo):
  - Lock-Step ISS-vs-DUT Verification with Automated Test-Case Minimisation — DOI: [10.5281/zenodo.20678504](https://doi.org/10.5281/zenodo.20678504)
  - Pure-Software RTL Co-Simulation via Verilated Peripheral Substitution — DOI: [10.5281/zenodo.20678643](https://doi.org/10.5281/zenodo.20678643)
  - Zero-Allocation Deterministic Snapshot/Restore Enabling Reverse Debugging — DOI: [10.5281/zenodo.20678682](https://doi.org/10.5281/zenodo.20678682)
